...
\begin{remark}[Completions, gradings, and spectral parameters] \label{remark: completions_gradings_and_spectral_parameters}
    ...
    \begin{enumerate}
        ...
        \item \todo[inline]{Relationship between gradings and completions}
        \item \todo[inline]{Spectral parameters}
    \end{enumerate}
\end{remark}
