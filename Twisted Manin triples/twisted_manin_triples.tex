\section{Twisted Manin triples}
    ...
    \subsection{Triangular-decomposable Lie algebras abd their automorphisms}
        ...
        As an interlude, let us consider a Kac-Moody algebra $\g$, which is triangular-decomposable by construction (see \cite[Theorem 1.2]{kac_infinite_dimensional_lie_algebras}). When $\g$ either of finite or affine type, there is an associated \say{Kac-Moody group}:
            $$\frakG$$
        whose construction we recall now, following the presentation from \cite{perrin_kac_moody_algebras}.
        \todo[inline]{Recall the construction of Kac-Moody groups for context.}
