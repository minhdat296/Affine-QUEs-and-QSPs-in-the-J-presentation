    ...
    \subsection{Invariant twists and solutions to CYBEs} \label{subsection: invariantly_twisted_coboundary_topological_lie_bialgebras}
        ...
        \end{theorem}
            \begin{proof}
                ...
                \todo[inline]{I'm rewriting this so that it will be easier to use in section \ref{section: invariant_twists_and_belavin_drinfeld_classification}. I think the stated theorem is equivalent to saying that $\vartheta$ twists invariantly if and only if $(\vartheta \tensor \vartheta)(\calr)$ is another solution to the CYBE. I have a proof when $\calr$ is skew-symmetric/unitary, and I'm trying to see if this condition is necessary.}
            \end{proof}
